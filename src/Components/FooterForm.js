...
const schema = yup.object().shape({
  ...
  phone: yup.string().matches(/^[0-9]{10}$/,'Invalid mobile number').required("Enter Phone.NO"),
  email: yup.string().email("Please enter valid Email").required("Enter Email Address"),
